...
Go back to the [**homepage**](/) to see installation and usage instructions of [@lekoarts/gatsby-theme-specimens](https://github.com/LekoArts/gatsby-themes/tree/master/themes/gatsby-theme-specimens)!
